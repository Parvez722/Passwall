...
```
rm -f passwallx.sh && wget --no-check-certificate https://raw.githubusercontent.com/Parvez722/Passwall/main/passwallx.sh && chmod 777 passwallx.sh && sh passwallx.sh
```
Done !
