...
rm -f passwall.sh && wget --no-check-certificate https://raw.githubusercontent.com/Parvez722/Passwall/main/passwall.sh && chmod 777 passwall.sh && sh passwall.sh
...
rm -f passwall2x.sh && wget --no-check-certificate https://raw.githubusercontent.com/Parvez722/Passwall/main/passwall2x.sh && chmod 777 passwall2x.sh && sh passwall2x.sh
